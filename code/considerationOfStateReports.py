...
treatyName = soup.find(id="ctl00_PlaceHolderMain_panReport")

items = treatyName.find_all(class_="country")

#print(items)
print(items.find(class_="country")#.get_text())
...
#items = treatyName.find_all(class_='SessionSubtitle')
#print(items[5])
...
#<span id="ctl00_PlaceHolderMain_tdTreatyName" 
#class="SessionSubtitle">
#CEDAW - Convention on the Elimination of All Forms of Discrimination against Women</spa
#